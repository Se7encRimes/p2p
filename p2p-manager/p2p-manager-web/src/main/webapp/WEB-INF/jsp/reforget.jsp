        ...
        <div class="m2-loginArea-rig">
          ...
          <form class="m2-login-form" action="#">
            <div class="m2-loginForm-item m2-login-pwd" style="margin:25px 0 0 0;">
              <span><i></i></span>
              <input type="password" id="password1" placeholder="新密码">
              <b id="passwarn1"></b>
            </div>
          ...
          <div class="m2-login-submit">
            <a href="javascript:;" onclick="login();" class="m2-loginBtn">确认修改</a>
          </div>
...
<script type="text/javascript">
  function login(){
    ...
    var p = makevar(['password1','password2']);
    var canSubmit = true;
    $(".alarmnew").html("");
    if(typeof p.password1=="undefined" ||　typeof p.password==null || p.password==""){

      $(".alarmnew").html("密码不能为空");
      return false;
    }
    if(typeof p.password2=="undefined" ||　typeof p.password==null || p.password==""){
