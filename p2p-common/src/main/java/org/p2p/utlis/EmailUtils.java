...
public class EmailUtils {
    private static String fromEmail="style_0018@163.com";//发件邮箱
    private static String sqm="uuu123";//授权码
    ...
    public static void sendEmail(String toEmail,String title,String content)  {
        ...
        try {
            ...
            //设置消息信息
            message.setFrom(new InternetAddress(fromEmail, "网上书城","UTF-8"));//设置发件人信息
